...
public class DateUtil {
	...
	public static String yyyyMMDDHH24MISSsss = "yyyyMMddHHmmsssss";
	...
	public static String yyyyMMddHHmmssChina = "yyyy年MM月dd日 HH:mm:ss";
	public static String yyyyMMddChina = "yyyy年MM月dd日";
	...
	public static void main(String[] args) {
		String beginDate = date2Str(new Date(), "yyyy-MM")+"-01";
		String endDate = date2Str(new Date(), "yyyy-MM-dd");
		...
		System.out.println(DateUtil.getIntervalDay(new Date() , false, 180));
	}
}
